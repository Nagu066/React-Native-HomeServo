...
import BusinessDeatilsScreen from '../Screens/BusinessDetailsScreen/BusinessDeatilsScreen';
...
export default function HomeNavigation() {
  return (
    <Stack.Navigator screenOptions={{
        ...
        <Stack.Screen name='business-detail' component={BusinessDeatilsScreen}/>
    </Stack.Navigator>
  )
}